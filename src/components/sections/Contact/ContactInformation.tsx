  ...
  return (
    <div>
      <div className="flex w-full flex-col gap-8 rounded-3xl border border-gray-700/20 bg-[#151C21] px-5 py-8 sm:px-8 sm:py-10">
        <p className="font-inter text-lg font-bold tracking-wide text-white sm:text-xl">
          Contact Information
        </p>
        <div className="ml-2 flex flex-col gap-6 sm:gap-10">
          <div className="flex items-center justify-start gap-3">
            ...
            <div>
              <p className="font-inter text-xs text-white/30 sm:text-sm">
                Email
              </p>
              <p className="font-inter text-sm text-nowrap text-white/90 sm:text-base">
      ...
      <div className="border-green/40 mt-5 w-full rounded-3xl border bg-[#151E23] px-5 py-8 sm:mt-8">
        <div className="flex items-center gap-3">
          ...
          <p className="text-md font-inter tracking-wide text-white">
            Currently Available
          </p>
        </div>
        <p className="font-inter mt-5 px-1 text-sm tracking-wide text-white/40">
