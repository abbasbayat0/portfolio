  ...
  return (
    <article className="mt-36 flex max-w-375 flex-col items-center justify-center">
      ...
      <section className="mt-20 flex w-full flex-col">
        <div className="w-full rounded-2xl border border-[#20b2a6]/40 bg-[#151E23] px-4 py-8">
          <form
            action=""
          ...
          >
            ...
            <input
              ...
              id="name"
              required
              className="font-inter -mt-4 rounded-lg border border-gray-800 bg-[#1A2329] p-3 text-sm text-white/40 transition duration-300 focus:border-2 focus:border-[#20b2a6] focus:outline-none"
            ...
            <textarea
              ...
              id="message"
              required
              className="font-inter -mt-4 resize-none rounded-lg border border-gray-800 bg-[#1A2329] p-3 text-sm text-white/40 transition duration-300 focus:border-2 focus:border-[#20b2a6] focus:outline-none"
              placeholder="Your message"
            ></textarea>
            <button type="submit" className="flex w-full justify-center">
              <Button
                className="font-inter text-md flex w-full items-center justify-center gap-2 font-medium shadow-[0_2px_10px_1px] shadow-[#20b2a6]/40"
                size="lg"
              >
                Send Message
