    ...
    >
      <div className={`relative max-w-113 min-[870px]:w-11/12 lg:w-full`}>
        ...
        <motion.div
          ...
          className={`lg:py-auto lg:px-auto absolute -top-1/12 -left-4 z-10 flex animate-[ex_3s_ease-in-out_infinite] items-center justify-center rounded-xl border border-[#1a2329] bg-[#1a2329]/50 px-1 py-1 backdrop-blur-xs min-[500px]:-top-8 min-[500px]:-left-5 min-[870px]:-top-8 lg:-top-10 lg:-left-8 lg:h-20 lg:w-24 ${!imageLoaded && "hidden"}`}
        >
        ...
        <motion.div
          ...
          animate={{ opacity: 1 }}
          transition={{ duration: 1, delay: 2, ease: "backIn" }}
          className={`lg:px-auto lg:py-auto absolute -right-4 bottom-0 z-10 flex animate-[ex_3s_ease-in-out_infinite] items-center justify-center gap-2 rounded-xl border border-[#1a2329] bg-[#1a2329]/50 px-2 py-1 backdrop-blur-xs lg:-right-8 lg:-bottom-4 lg:h-10 lg:w-40 ${!imageLoaded && "hidden"}`}
        >
